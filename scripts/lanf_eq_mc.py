...
slr_5 = pd.DataFrame(index=mc_index, columns=mc_cols) #DF for SLR MC, >= M5 eqs
...
for ii in mc_index:
    ...
    for t in time_window:
        ss[t] = eqs.get_prob_above_val_in_window(eq_series, 5, t) *slr_dip_frac 
